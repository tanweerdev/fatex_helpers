defmodule Fatex.MixProject do
  ...
  def project do
    [
      ...
      source_url: "https://github.com/tanweerdev/fatex_helpers",
  ...
  defp description() do
    "fatex_helpers provides methods for dynamically building queries according to the parameters it receive."
  end
  ...
  defp package() do
    [
      ...
      links: %{
        "GitHub" => "https://github.com/tanweerdev/fatex_helpers",
        "Docs" => "https://hexdocs.pm/fatex_helpers/"
      }
    ]
  end
