defmodule Fatex.MapHelper do
  ...
  ## Examples
      iex> Fatex.MapHelper.has_all_keys?(%{a: 1, b: 2}, [:a, :b])
      true
      iex> Fatex.MapHelper.has_all_keys?(%{a: 1}, [:a, :b])
      false
  """
  ...
  ## Examples
      iex> Fatex.MapHelper.has_all_keys_exclusive?(%{a: 1, b: 2}, [:a, :b])
      true
      iex> Fatex.MapHelper.has_all_keys_exclusive?(%{a: 1, c: 3}, [:a, :b])
      false
  """
  ...
  ## Examples
      iex> Fatex.MapHelper.contain_only_allowed_keys?(%{a: 1, b: 2}, [:a, :b])
      true
      iex> Fatex.MapHelper.contain_only_allowed_keys?(%{a: 1, c: 3}, [:a, :b])
      false
  """
  ...
  ## Examples
      iex> Fatex.MapHelper.has_all_val_equal_to?(%{a: 1, b: 1}, [:a, :b], 1)
      true
      iex> Fatex.MapHelper.has_all_val_equal_to?(%{a: 1, b: 2}, [:a, :b], 1)
      false
  """
  ...
  ## Examples
      iex> Fatex.MapHelper.has_any_of_keys?(%{a: 1}, [:a, :b])
      true
      iex> Fatex.MapHelper.has_any_of_keys?(%{c: 3}, [:a, :b])
      false
  """
  ...
  ## Examples
      iex> Fatex.MapHelper.get_keys_count(%{a: 1, b: 2}, [:a, :b, :c])
      2
  """
  ...
  ## Examples
      iex> Fatex.MapHelper.deep_merge(%{a: %{b: 1}}, %{a: %{c: 2}})
      %{a: %{b: 1, c: 2}}
  """
